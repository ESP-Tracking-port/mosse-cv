...
#include "embmosse/Types/EigenAux.hpp"
...
#include "embmosse/Util/Helper/EigenVisitor.hpp"
...
public:
	...
	void imageCropPreprocessImpl(const Tp::Image &aImage, void *aBufferCplx, Tp::NumVariant mean, Tp::NumVariant stddev) override
	{
